...
{
    //This test was created by mfagerlund: http://farseerphysics.codeplex.com/workitem/29643
    //Used to debug the bug inside CCD. Turn off CCD and this test performs as it should.
    ...
    public class WallHuggingExample : Test
    {
        ...
        private void GenerateParticle()
        {
            ...
            dir.Normalize();
            Vector2 position = new Vector2(5.010656f, 5.000453f);

            const float speed = (float)20;
