...
namespace FarseerPhysics.TestBed.Tests
{
    public static class TestEntries
    {
        public static TestEntry[] TestList =
        {
            ...
            new TestEntry {Name = "Car", CreateFcn = CarTest.Create},
            ...
            new TestEntry {Name = "RopeJoint", CreateFcn = RopeTest.Create},
            ...
            new TestEntry {Name = "Convex hull test", CreateFcn = ConvexHullTest2.Create},
