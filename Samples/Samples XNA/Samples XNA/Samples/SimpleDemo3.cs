...
namespace FarseerPhysics.SamplesFramework
{
    internal class SimpleDemo3 : PhysicsGameScreen, IDemoScreen
    {
        ...
        private void LoadObstacles()
        {
            ...
            _obstacles[0].P = new Vector2(-5f, 9f);
            _obstacles[1].P = new Vector2(15f, 6f);
            _obstacles[2].P = new Vector2(10f, -3f);
            _obstacles[3].P = new Vector2(-10f, -9f);
            _obstacles[4].P = new Vector2(-17f, 0f);
