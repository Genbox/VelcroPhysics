...
namespace FarseerPhysics.DemoBaseXNA
{
    ...
    */
    public class Material
    {
        ...
        public static Material Metal = new Material(7.85f, 0.20f, 0.2f, false, false, false, Color.LightGray); // Heavy, inert.
        public static Material Stone = new Material(2.40f, 0.50f, 0.1f, false, false, false, Color.DarkGray); // Heavy, inert.
        public static Material Wood = new Material(0.53f, 0.40f, 0.15f, false, true, false, new Color(150, 98, 0)); // Medium weight, mostly inert.
        public static Material Glass = new Material(2.50f, 0.10f, 0.2f, false, true, true, new Color(0, 0, 220, 128)); // Heavy, transparent.
        public static Material Rubber = new Material(1.50f, 0.80f, 0.4f, false, false, false, new Color(20, 20, 20)); // Medium weight, inert, bouncy.
        public static Material Ice = new Material(0.92f, 0.01f, 0.1f, false, true, true, new Color(0, 146, 220, 200)); // Medium weight, slippery surface.
        public static Material Pumice = new Material(0.25f, 0.60f, 0.0f, false, true, true, Color.White); // Light, fragile.
        public static Material Polystyrene = new Material(0.10f, 0.60f, 0.05f, false, true, true, Color.White); // Light, fragile.
        public static Material Fabric = new Material(0.03f, 0.60f, 0.1f, true, true, true, Color.Pink); // Medium weight, grabbable.
        public static Material Sponge = new Material(0.018f, 0.90f, 0.05f, true, true, true, Color.Yellow); // Light, fragile, grabbable.
        public static Material Air = new Material(0.001f, 0.90f, 0.0f, true, true, true, new Color(142, 171, 255, 128)); // No gravity?
        public static Material Helium = new Material(0.0001f, 0.9f, 0.0f, true, true, true, new Color(142, 171, 255, 128)); // Negative gravity?
