            ...
            for (int i = 0; i < count; i++)
            {
                ...
                switch (type)
                {
                    case ObjectType.Circle:
                        body = BodyFactory.CreateCircle(world, radius, 1, material);
                        _bodies.Add(body);
                        break;
                    case ObjectType.Rectangle:
                        body = BodyFactory.CreateRectangle(world, radius, radius, 1, material);
                        _bodies.Add(body);
                        break;
                    case ObjectType.Star:
                        Body star = BodyFactory.CreateGear(world, radius, 10, 0f, 1f, 1, material);
                        _bodies.Add(star);
                        break;
                    case ObjectType.Gear:
                        Body gear = BodyFactory.CreateGear(world, radius, 10, 100f, 1f, 1, material);
                        _bodies.Add(gear);
                        break;
                    default:
                        body = BodyFactory.CreateCircle(world, radius, 1, material);
