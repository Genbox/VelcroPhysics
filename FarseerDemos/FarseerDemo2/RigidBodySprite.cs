...
namespace FarseerDemo2  {
    ...
    public class RigidBodySprite    {
        ...
        public RigidBodySprite(string textureName, GraphicsDevice graphicsDevice,PhysicsSimulator physicsSimulator) {
            ...
            rigidBody.RestitutionCoefficient = .3f;
