...
namespace FarseerGames.Components {
    public partial class KeyboardInputComponent : Microsoft.Xna.Framework.GameComponent {
        ...
        //Space
        public event EventHandler<KeyEventArgs> SpaceKeyDown;
        public event EventHandler<KeyEventArgs> SpaceKeyUp;
        public event EventHandler<KeyEventArgs> SpaceKeyPressed;
        ...
        private void RaiseKeyDownEvent(Keys key) {
            switch (key) {
                ...
                case Keys.ShiftKey:
                    break;
                case Keys.Space:
                    if (SpaceKeyDown != null) { SpaceKeyDown(this, new KeyEventArgs()); }
                    break;
                case Keys.Subtract:
                    break;
                case Keys.T:
        ...
        private void RaiseKeyUpEvent(Keys key) {
            switch (key) {
                ...
                case Keys.ShiftKey:
                    break;
                case Keys.Space:
                    if (SpaceKeyUp != null) { SpaceKeyUp(this, new KeyEventArgs()); }
                    break;
                case Keys.Subtract:
                    break;
                case Keys.T:
        ...
        private void RaisKeyPressedEvent(Keys key) {
            switch (key) {
                ...
                case Keys.ShiftKey:
                    break;
                case Keys.Space:
                    if (SpaceKeyPressed != null) { SpaceKeyPressed(this, new KeyEventArgs()); }
                    break;
                case Keys.Subtract:
                    break;
                case Keys.T:
