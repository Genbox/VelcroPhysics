...
namespace FarseerSilverlightDemos.Demos.Demo6
{
    public class Demo6 : SimulatorView
    {
        ...
        public void LoadPlatforms() {
            ...
            platform1 = new RectanglePlatform(width, height, position, Media.Colors.White, Media.Colors.Black, 100);
            ...
            platform2 = new RectanglePlatform(width, height, position, Media.Colors.White, Media.Colors.Black, 100);
            ...
            platform3 = new RectanglePlatform(width, height, position, Media.Colors.White, Media.Colors.Black, 100);
            ...
            floor = new RectanglePlatform(ScreenManager.ScreenWidth + 10, height, new Vector2(ScreenManager.ScreenCenter.X, ScreenManager.ScreenHeight + 5 - height / 2), Media.Colors.Black, Media.Colors.Black, 0);
            ...
            linearSpring2 = ControllerFactory.Instance.CreateLinearSpring(physicsSimulator, agent.Body, Vector2.Zero, springRectangleRope2.FirstBody, Vector2.Zero, 200, 2f);
        }
