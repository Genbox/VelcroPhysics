...
namespace FarseerSilverlightDemos.Demos.DemoShare
{
    public class Border
    {
        ...
        public void Load(SimulatorView view, PhysicsSimulator physicsSimulator)
        {
            ...
            RectangleBrush r1 = view.AddRectangleToCanvas(null, Media.Color.FromArgb(128, 255, 255, 255), new Vector2(borderWidth * 2, ScreenManager.ScreenHeight));
            r1.Extender.Position = new Vector2(left, position.Y);
            RectangleBrush r2 = view.AddRectangleToCanvas(null, Media.Color.FromArgb(128, 255, 255, 255), new Vector2(borderWidth * 2, ScreenManager.ScreenHeight));
            r2.Extender.Position = new Vector2(right, position.Y);
            RectangleBrush r3 = view.AddRectangleToCanvas(null, Media.Color.FromArgb(128, 255, 255, 255), new Vector2(ScreenManager.ScreenWidth, borderWidth * 2));
            r3.Extender.Position = new Vector2(position.X, top);
            RectangleBrush r4 = view.AddRectangleToCanvas(null, Media.Color.FromArgb(128, 255, 255, 255), new Vector2(ScreenManager.ScreenWidth, borderWidth * 2));
