...
namespace FarseerGames.FarseerPhysicsDemos.Demos.Demo6 {
    public class Demo6Screen : GameScreen {
        ...
        Texture2D hangingTexture;
        Body hangingBody;
        Geom hangingGeom;
        FixedLinearSpring fixedLinearSpring1;

        AngularSpringLever angularSpringLever1;
        AngularSpringLever angularSpringLever2;
        AngularSpringLever angularSpringLever3;
        AngularSpringLever angularSpringLever4;

        LinearSpring linearSpring1;
        SpringRectangleRope springRectangleRope1;

        LinearSpring linearSpring2; 
        SpringRectangleRope springRectangleRope2;

        float platform1WidthRatio = .1f;
        float platform1HeightRatio = .6f;
        RectanglePlatform platform1;

        float platform2WidthRatio = .1f;
        float platform2HeightRatio = .7f;
        RectanglePlatform platform2;

        float platform3WidthRatio = .1f;
        float platform3HeightRatio = .6f;
        RectanglePlatform platform3;

        RectanglePlatform floor;
        ...
        public override void LoadContent() {
            ...
            border = new Border(ScreenManager.ScreenWidth + borderWidth * 2, ScreenManager.ScreenHeight + borderWidth * 2, borderWidth, ScreenManager.ScreenCenter);
        ...
        public void LoadPlatforms() {
            ...
            springPosition = position + new Vector2(width / 2f, -height / 2f) + new Vector2(-angularSpringLever1.RectangleHeight - 5, .4f * height);
            ...
            springPosition = position + new Vector2(-width / 2f, -height / 2f) + new Vector2(angularSpringLever2.RectangleHeight + 5, .2f * height);
            ...
            springPosition = position + new Vector2(width / 2f, -height / 2f) + new Vector2(-angularSpringLever3.RectangleHeight - 5, .1f * height);
            ...
            linearSpring1 = ControllerFactory.Instance.CreateLinearSpring(physicsSimulator, angularSpringLever3.Body, new Vector2(angularSpringLever3.RectangleWidth / 2, 0), springRectangleRope1.FirstBody, Vector2.Zero, 400, 3);  
            ...
            hangingTexture = DrawingHelper.CreateCircleTexture(ScreenManager.GraphicsDevice, 40, Color.White, Color.Black);
            ...
            fixedLinearSpring1 = ControllerFactory.Instance.CreateFixedLinearSpring(physicsSimulator,hangingBody, new Vector2(0, -35), new Vector2(position.X-200, 100), 2, .1f);
            ...
            springPosition = position + new Vector2(-width / 2f, -height / 2f) + new Vector2(angularSpringLever4.RectangleHeight + 5, .7f * height);
            ...
            floor = new RectanglePlatform(ScreenManager.ScreenWidth + 10, height, new Vector2(ScreenManager.ScreenCenter.X, ScreenManager.ScreenHeight + 5 - height / 2), Color.White, Color.Black,0);
            ...
            linearSpring2 = ControllerFactory.Instance.CreateLinearSpring(physicsSimulator, agent.Body, Vector2.Zero, springRectangleRope2.FirstBody, Vector2.Zero, 200, 4f);
        }
        ...
        public override void Draw(Microsoft.Xna.Framework.GameTime gameTime) {
            ...
            ScreenManager.SpriteBatch.Draw(hangingTexture, hangingGeom.Position, null, Color.White, hangingGeom.Rotation, new Vector2(hangingTexture.Width / 2, hangingTexture.Height / 2), 1, SpriteEffects.None, 0);
