...
namespace FarseerGames.FarseerPhysicsDemos.Demos.Demo3 {
    public class Demo3Screen : GameScreen{
        ...
        public void LoadAgent() {
            ...
            agentCrossBeamTexture = DrawingHelper.CreateRectangleTexture(ScreenManager.GraphicsDevice, 16, 120, Color.DarkGray, Color.Black);
        ...
        public void LoadFloor() {
            ...
            floorTexture = DrawingHelper.CreateRectangleTexture(ScreenManager.GraphicsDevice, ScreenManager.ScreenWidth, 100, Color.White,Color.Black);
        ...
        public void LoadObstacles() {
            obstacleTexture = DrawingHelper.CreateRectangleTexture(ScreenManager.GraphicsDevice, 128, 32, Color.White, Color.Black);
        ...
        public override void Draw(Microsoft.Xna.Framework.GameTime gameTime) {
            ...
            ScreenManager.SpriteBatch.Draw(floorTexture, floorBody.Position, null, Color.White, floorBody.Rotation, floorOrigin, 1, SpriteEffects.None, 0f);
            DrawObstacles();
            DrawAgent();
        ...
        private void DrawAgent() {
            for (int i = 5; i < 7; i++) {
                ScreenManager.SpriteBatch.Draw(agentCrossBeamTexture, agentGeom[i].Position, null, Color.White, agentGeom[i].Rotation, agentCrossBeamOrigin, 1, SpriteEffects.None, 0f);
            }
            for (int i = 0; i < 5; i++) {
                ScreenManager.SpriteBatch.Draw(agentTexture, agentGeom[i].Position, null, Color.White, agentGeom[i].Rotation, agentOrigin, 1, SpriteEffects.None, 0f);
            }
        }

        private void DrawObstacles() {
            for (int i = 0; i < obstacleBody.Length; i++) {
                ScreenManager.SpriteBatch.Draw(obstacleTexture, obstacleBody[i].Position, null, Color.White, obstacleBody[i].Rotation, obstacleOrigin, 1, SpriteEffects.None, 0f);
            }
        }
