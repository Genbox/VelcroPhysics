...
namespace FarseerGames.FarseerPhysicsDemos {
    public class PhysicsSimulatorView {
        ...
        private void DrawPerformancePanel(SpriteBatch spriteBatch){
            ...
            spriteBatch.DrawString(spriteFont, String.Format(updateTotal,physicsSimulator.UpdateTime.ToString("0.00")), new Vector2(110, 110), Color.White);
            spriteBatch.DrawString(spriteFont, String.Format(cleanUp, physicsSimulator.CleanUpTime.ToString("0.00")), new Vector2(120, 125), Color.White);
            spriteBatch.DrawString(spriteFont, String.Format(broadPhaseCollision, physicsSimulator.BroadPhaseCollisionTime.ToString("0.00")), new Vector2(120, 140), Color.White);
            spriteBatch.DrawString(spriteFont, String.Format(narrowPhaseCollision, physicsSimulator.NarrowPhaseCollisionTime.ToString("0.00")), new Vector2(120, 155), Color.White);
            spriteBatch.DrawString(spriteFont, String.Format(applyForces, physicsSimulator.ApplyForcesTime.ToString("0.00")), new Vector2(120, 170), Color.White);
            spriteBatch.DrawString(spriteFont, String.Format(applyImpulses, physicsSimulator.ApplyImpulsesTime.ToString("0.00")), new Vector2(120, 185), Color.White);
            spriteBatch.DrawString(spriteFont, String.Format(updatePosition, physicsSimulator.UpdatePositionsTime.ToString("0.00")), new Vector2(120, 200), Color.White);
