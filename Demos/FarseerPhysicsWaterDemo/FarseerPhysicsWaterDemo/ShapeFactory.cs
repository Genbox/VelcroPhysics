...
namespace FarseerPhysicsWaterDemo
{
    ...
    {
        public static Polygon CreatePolygon(PointCollection points, Color? fillColor, Color? borderColor, double? borderWidth)
        {
        ...
        public static Rectangle CreateRectangle(float width, float height, Color fill, Color stroke, float strokeThickness)
        {
