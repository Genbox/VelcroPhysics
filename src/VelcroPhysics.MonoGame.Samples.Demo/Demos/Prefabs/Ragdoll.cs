...
namespace Genbox.VelcroPhysics.MonoGame.Samples.Demo.Demos.Prefabs
{
    public class Ragdoll
    {
        ...
        public Ragdoll(World world, Vector2 position)
        {
            ...
            // GFX
            _face = new Sprite(ContentWrapper.CircleTexture(0.75f, "Square", Colors.Gold, Colors.Orange, Colors.Grey, 1f));
            _torso = new Sprite(ContentWrapper.PolygonTexture(PolygonUtils.CreateRoundedRectangle(1.5f, 2f, 0.75f, 0.75f, 2), "Stripe", Colors.Gold, Colors.Orange, Colors.Black, 2.0f));
            _upperLimb = new Sprite(ContentWrapper.PolygonTexture(PolygonUtils.CreateCapsule(1.9f, 0.45f, 16), "Square", Colors.Gold, Colors.Orange, Colors.Black, 1f));
            _lowerLimb = new Sprite(ContentWrapper.PolygonTexture(PolygonUtils.CreateCapsule(2f, 0.5f, 16), "Square", Colors.Gold, Colors.Orange, Colors.Black, 1f));
        }
