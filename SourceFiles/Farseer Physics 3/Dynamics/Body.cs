...
namespace FarseerPhysics.Dynamics
{
	...
	public class Body : IDisposable
	{
		...
		private PhysicsSimulator _world;
		internal Body _prev;
		internal Body _next;
		...
		internal Dynamics.Controllers.ControllerEdge _controllerList;
		...
		internal Body(BodyDef bd, PhysicsSimulator world)
		{
			...
			_sweep.C0 = _sweep.C = FarseerPhysics.Common.Math.Mul(_xf, _sweep.LocalCenter);
		...
		public void ApplyForce(Vector2 force, Vector2 point)
		{
            ...
            _torque += FarseerPhysics.Common.Math.Cross(ref temp, ref force);
		}
		...
		public void ApplyImpulse(Vector2 impulse, Vector2 point)
		{
            ...
            Vector2 temp = point - _sweep.C;
            _angularVelocity += _invI * FarseerPhysics.Common.Math.Cross(ref temp, ref impulse);
		}
		...
		{
			return FarseerPhysics.Common.Math.Mul(_xf, localPoint);
		}
		...
		{
            return FarseerPhysics.Common.Math.Mul(_xf.R, localVector);
		}
		...
		{
            return FarseerPhysics.Common.Math.MulT(_xf, worldPoint);
		}
		...
		{
            return FarseerPhysics.Common.Math.MulT(_xf.R, worldVector);
		}
		...
		{
            return _linearVelocity + FarseerPhysics.Common.Math.Cross(_angularVelocity, worldPoint - _sweep.C);
		}
		...
		/// </summary>
		/// <returns></returns>
		public PhysicsSimulator GetWorld() { return _world; }

		internal bool SynchronizeShapes()
		{
			XForm xf1 = new XForm();
			xf1.R.Set(_sweep.A0);
			xf1.Position = _sweep.C0 - FarseerPhysics.Common.Math.Mul(xf1.R, _sweep.LocalCenter);
		...
		{
			_xf.R.Set(_sweep.A);
            _xf.Position = _sweep.C - FarseerPhysics.Common.Math.Mul(_xf.R, _sweep.LocalCenter);
		}
