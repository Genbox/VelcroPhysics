...
namespace FarseerPhysics.Dynamics
{
    ...
    public class LineJoint : Joint
    {
            ...
            : base(def)
        {
            ...
            _localYAxis1 = MathHelper.Cross(1.0f, _localXAxis1);
        ...
        public float GetJointSpeed()
        {
            ...
            float speed = Vector2.Dot(d, MathHelper.Cross(w1, axis)) +
                          Vector2.Dot(axis, v2 + MathHelper.Cross(w2, r2) - v1 - MathHelper.Cross(w1, r1));
            return speed;
        }
        ...
        internal override void InitVelocityConstraints(TimeStep step)
        {
            ...
            Vector2 r1 = MathHelper.Mul(xf1.R, _localAnchor1 - _localCenter1);
            Vector2 r2 = MathHelper.Mul(xf2.R, _localAnchor2 - _localCenter2);
            ...
            {
                _axis = MathHelper.Mul(xf1.R, _localXAxis1);
                Vector2 temp = d + r1;
                _a1 = MathHelper.Cross(ref temp, ref _axis);
                _a2 = MathHelper.Cross(ref r2, ref _axis);
            ...
            {
                _perp = MathHelper.Mul(xf1.R, _localYAxis1);
                Vector2 temp2 = d + r1;
                _s1 = MathHelper.Cross(ref temp2, ref _perp);
                _s2 = MathHelper.Cross(ref r2, ref _perp);
            ...
            if (_enableLimit)
            {
                ...
                if (MathHelper.Abs(_upperTranslation - _lowerTranslation) < 2.0f*Settings.LinearSlop)
                {
        ...
        internal override void SolveVelocityConstraints(TimeStep step)
        {
            ...
            if (_enableLimit && _limitState != LimitState.InactiveLimit)
            {
                ...
                if (_limitState == LimitState.AtLowerLimit)
                {
                    _impulse.Y = MathHelper.Max(_impulse.Y, 0.0f);
                }
                else if (_limitState == LimitState.AtUpperLimit)
                {
                    _impulse.Y = MathHelper.Min(_impulse.Y, 0.0f);
                }
        ...
        internal override bool SolvePositionConstraints(float baumgarte)
        {
            ...
            Vector2 r1 = MathHelper.Mul(R1, _localAnchor1 - _localCenter1);
            Vector2 r2 = MathHelper.Mul(R2, _localAnchor2 - _localCenter2);
            Vector2 d = c2 + r2 - c1 - r1;

            if (_enableLimit)
            {
                _axis = MathHelper.Mul(R1, _localXAxis1);
                Vector2 temp = d + r1;
                _a1 = MathHelper.Cross(ref temp, ref _axis);
                _a2 = MathHelper.Cross(ref r2, ref _axis);
                ...
                if (MathHelper.Abs(_upperTranslation - _lowerTranslation) < 2.0f*Settings.LinearSlop)
                {
                    ...
                    linearError = MathHelper.Abs(translation);
                    active = true;
                }
                else if (translation <= _lowerTranslation)
                {
                    // Prevent large linear corrections and allow some slop.
                    C2 = MathHelper.Clamp(translation - _lowerTranslation + Settings.LinearSlop, -Settings.MaxLinearCorrection,
                                    0.0f);
            ...
            _perp = MathHelper.Mul(R1, _localYAxis1);
            Vector2 temp2 = d + r1;
            _s1 = MathHelper.Cross(ref temp2, ref _perp);
            _s2 = MathHelper.Cross(ref r2, ref _perp);
            ...
            linearError = MathHelper.Max(linearError, MathHelper.Abs(C1));
            angularError = 0.0f;
