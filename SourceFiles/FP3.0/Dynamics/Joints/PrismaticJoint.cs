...
namespace FarseerPhysics.Dynamics
{
    ...
    public class PrismaticJoint : Joint
    {
            ...
            : base(def)
        {
            ...
            _localYAxis1 = CommonMath.Cross(1.0f, _localXAxis1);
        ...
        public float JointSpeed
        {
            get
            {
                ...
                float speed = Vector2.Dot(d, CommonMath.Cross(w1, axis)) +
                              Vector2.Dot(axis, v2 + CommonMath.Cross(w2, r2) - v1 - CommonMath.Cross(w1, r1));
                return speed;
            }
        }
        ...
        internal override void InitVelocityConstraints(TimeStep step)
        {
            ...
            Vector2 r1 = CommonMath.Mul(xf1.R, _localAnchor1 - _localCenter1);
            Vector2 r2 = CommonMath.Mul(xf2.R, _localAnchor2 - _localCenter2);
            ...
            {
                _axis = CommonMath.Mul(xf1.R, _localXAxis1);
                Vector2 temp = d + r1;
                _a1 = CommonMath.Cross(ref temp, ref _axis);
                _a2 = CommonMath.Cross(ref r2, ref _axis);
            ...
            {
                _perp = CommonMath.Mul(xf1.R, _localYAxis1);
                Vector2 temp = d + r1;
                _s1 = CommonMath.Cross(ref temp, ref _perp);
                _s2 = CommonMath.Cross(ref r2, ref _perp);
            ...
            if (_enableLimit)
            {
                ...
                if (CommonMath.Abs(_upperTranslation - _lowerTranslation) < 2.0f*Settings.LinearSlop)
                {
        ...
        internal override void SolveVelocityConstraints(TimeStep step)
        {
            ...
            if (_enableLimit && _limitState != LimitState.InactiveLimit)
            {
                ...
                if (_limitState == LimitState.AtLowerLimit)
                {
                    _impulse.Z = CommonMath.Max(_impulse.Z, 0.0f);
                }
                else if (_limitState == LimitState.AtUpperLimit)
                {
                    _impulse.Z = CommonMath.Min(_impulse.Z, 0.0f);
                }
        ...
        internal override bool SolvePositionConstraints(float baumgarte)
        {
            ...
            Vector2 r1 = CommonMath.Mul(R1, _localAnchor1 - _localCenter1);
            Vector2 r2 = CommonMath.Mul(R2, _localAnchor2 - _localCenter2);
            Vector2 d = c2 + r2 - c1 - r1;

            if (_enableLimit)
            {
                _axis = CommonMath.Mul(R1, _localXAxis1);
                Vector2 temp = d + r1;
                _a1 = CommonMath.Cross(ref temp, ref _axis);
                _a2 = CommonMath.Cross(ref r2, ref _axis);
                ...
                if (CommonMath.Abs(_upperTranslation - _lowerTranslation) < 2.0f*Settings.LinearSlop)
                {
                    ...
                    C2 = CommonMath.Clamp(translation, -Settings.MaxLinearCorrection, Settings.MaxLinearCorrection);
                    linearError = CommonMath.Abs(translation);
                    active = true;
                }
                else if (translation <= _lowerTranslation)
                {
                    // Prevent large linear corrections and allow some slop.
                    C2 = CommonMath.Clamp(translation - _lowerTranslation + Settings.LinearSlop,
                ...
                {
                    // Prevent large linear corrections and allow some slop.
                    C2 = CommonMath.Clamp(translation - _upperTranslation - Settings.LinearSlop, 0.0f,
            ...
            _perp = CommonMath.Mul(R1, _localYAxis1);
            Vector2 temp2 = d + r1;
            _s1 = CommonMath.Cross(ref temp2, ref _perp);
            _s2 = CommonMath.Cross(ref r2, ref _perp);
            ...
            linearError = CommonMath.Max(linearError, CommonMath.Abs(C1.X));
            angularError = CommonMath.Abs(C1.Y);
