...
namespace FarseerPhysics.Dynamics
{
    ...
    public class DistanceJoint : Joint
    {
        ...
        internal override void InitVelocityConstraints(TimeStep step)
        {
            ...
            float cr1u = CommonMath.Cross(ref r1, ref _u);
            float cr2u = CommonMath.Cross(ref r2, ref _u);
            ...
            if (step.WarmStarting)
            {
                ...
                b1._angularVelocity -= b1._invI*CommonMath.Cross(ref r1, ref P);
                b2._linearVelocity += b2._invMass*P;
                b2._angularVelocity += b2._invI*CommonMath.Cross(ref r2, ref P);
            }
            else
            {
                _impulse = 0.0f;
        ...
        internal override bool SolvePositionConstraints(float baumgarte)
        {
            ...
            float C = length - _length;
            C = CommonMath.Clamp(C, -Settings.MaxLinearCorrection, Settings.MaxLinearCorrection);
            ...
            b1._sweep.A -= b1._invI*CommonMath.Cross(ref r1, ref P);
            b2._sweep.C += b2._invMass*P;
            b2._sweep.A += b2._invI*CommonMath.Cross(ref r2, ref P);

            b1.SynchronizeTransform();
            b2.SynchronizeTransform();

            return CommonMath.Abs(C) < Settings.LinearSlop;
        }
