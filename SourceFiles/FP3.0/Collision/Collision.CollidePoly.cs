...
namespace FarseerPhysics.Collision
{
	public partial class Collision
	{
			...
			PolygonShape polyA, XForm xfA, PolygonShape polyB, XForm xfB)
		{
            ...
            Vector2 frontNormal = FarseerPhysics.Common.Math.Cross(sideNormal, 1.0f);
			...
			for (int i = 0; i < Settings.MaxManifoldPoints; ++i)
			{
				...
				if (separation <= 0.0f)
				{
                    ...
                    cp.LocalPoint1 = FarseerPhysics.Common.Math.MulT(xfA, clipPoints2[i].V);
                    cp.LocalPoint2 = FarseerPhysics.Common.Math.MulT(xfB, clipPoints2[i].V);
