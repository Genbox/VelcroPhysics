...
namespace FarseerPhysics.Collision
{
    ...
    public class CircleShape : Shape
    {
        ...
        {
            Vector2 center = transform.Position + MathHelper.Mul(transform.R, _localPosition);
            Vector2 d = p - center;
                                                   ...
                                                   Segment segment, float maxLambda)
        {
            ...
            Vector2 position = transform.Position + MathHelper.Mul(transform.R, _localPosition);
            ...
            float a = -(c + MathHelper.Sqrt(sigma));
        ...
        public override void ComputeAABB(out AABB aabb, XForm transform)
        {
            ...
            Vector2 p = transform.Position + MathHelper.Mul(transform.R, _localPosition);
        ...
        public override void ComputeSweptAABB(out AABB aabb, XForm transform1, XForm transform2)
        {
            ...
            Vector2 p1 = transform1.Position + MathHelper.Mul(transform1.R, _localPosition);
            Vector2 p2 = transform2.Position + MathHelper.Mul(transform2.R, _localPosition);
            Vector2 lower = MathHelper.Min(p1, p2);
            Vector2 upper = MathHelper.Max(p1, p2);
        ...
        {
            c = new Vector2();
            Vector2 p = MathHelper.Mul(xf, _localPosition);
