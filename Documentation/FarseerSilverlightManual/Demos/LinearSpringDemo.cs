...
namespace FarseerSilverlightManual.Demos
{
    public class LinearSpringDemo : SimulatorView
    {
        ...
        public override void Initialize()
        {
            ...
            LinearSpring linearSpring = SpringFactory.Instance.CreateLinearSpring(physicsSimulator, rectangleBody, Vector2.Zero, rectangleBody1,
                                                                                  Vector2.Zero, 10f, 20f);
            linearSpring.RestLength = 10;
